  ...
  <div id="acara" class="row mt-5">
    ...
    <div id="gallery" class="row justify-content-center" data-aos="ease-in" data-aos-delay="500">
      ...
      <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
        <img src="<?= base_url() ?>/img/gallery1.JPG" class="w-100 shadow rounded mb-4" alt="Boat on Calm Water" />
        <img src="<?= base_url() ?>/img/default.webp" class="w-100 shadow rounded mb-4" alt="Wintry Mountain Landscape" />
      </div>
      <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
        <img src="<?= base_url() ?>/img/gallery1.JPG" class="w-100 shadow rounded mb-4" alt="Boat on Calm Water" />
        <img src="<?= base_url() ?>/img/default.webp" class="w-100 shadow rounded mb-4" alt="Wintry Mountain Landscape" />
