      ...
      <div class="row">
        <div class="col-sm-12 col-md-4 col-lg-4">
          <div class="lembaga d-flex">
            <img class="img-thumbnail bg-dark rounded-circle" width="50" height="50" src="<?= base_url() ?>/img/logo.webp">
            <h3 class="lead m-2 text-light">IPHI Kabupaten Karanganyar</h3>
          </div>
          <div class="m-2">
